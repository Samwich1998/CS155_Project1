...
class elasticNet:
    ...
    def saveModel(self, modelPath = "./RG.sav"):
        joblib.dump(self.model, 'scoreregressionRG.pkl')    
    ...
    def createModel(self):
        self.model = ElasticNet(alpha=1.0, l1_ratio=0.5, fit_intercept=True, precompute=False, max_iter=1000, copy_X=True, tol=0.0001, warm_start=False, selection='cyclic')
       # print("ElasticNet Model Created")
